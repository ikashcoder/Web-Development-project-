...
app.get("/filter", (req, res) => {
  ...
  const foundJoke = jokes.filter((joke) => joke.jokeType ===joke_type);
  res.json(foundJoke);
});

//4. POST a new joke
app.post("/jokes",(req,res)=>{
  let joke_type = req.body.type;
  let joke_Text = req.body.text;
  ...
  if(joke_type && joke_Text)
  ...
  else if(joke_Text)
    {
      new_joke ={
        id : id,
        jokeText : joke_Text,
        jokeType: jokes[searchIndex].jokeType
      };
      jokes[searchIndex] =new_joke;
      res.json(new_joke);
    }
    ...
    new_joke ={
      id : id,
      jokeText : jokes[searchIndex].jokeText,
      jokeType: joke_type
    };
    jokes[searchIndex] =new_joke;
    res.json(new_joke);
